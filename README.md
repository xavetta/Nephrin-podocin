...
This repository contains additional data for the publication "Podocin oligomers regulate the ordering of nephrin chains, providing the molecular basis of _NPHS2_ interallelic interactions". The following data are uploaded: the primer sequences in an Excel document; vector sequences in Genebank data format; the codes used for the image processing (ImageJ macros); the codes used for the statistical analysis of renal survival rates (Jupyterlab file); and the Statica Workfile containing all statical analysis. Raw data are available as supplementary at www.pnas.org. Additionally, all pre-processed raw HEK-293 and podocyte confocal microscopy files are available at The BioImage Archive (https://doi.org/10.6019/S-BIAD2863).
